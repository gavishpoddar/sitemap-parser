...
def sitemap_tree_for_homepage(homepage_url, recursion_level=1, web_client=None):
    """
    ...
    robots_txt_fetcher = SitemapFetcher(url=robots_txt_url, web_client=web_client, recursion_level=recursion_level)
